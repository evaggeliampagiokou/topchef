...
where group_name not in (
    ...
    from ingredients
    where recipe_id in(
		select recipe_id from contestant_pool));
#to dele the one i added
#delete from food_groups where group_name="test test";
